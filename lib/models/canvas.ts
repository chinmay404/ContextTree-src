...
export interface UserPreferences {
  ...
  savePreferences: UserSavePreferences
}

// Missing export - UserSavePreferences
export interface UserSavePreferences {
...
// Missing export - ConversationSaveAnalytics
export interface ConversationSaveAnalytics {
  totalNodes: number
  totalEdges: number
