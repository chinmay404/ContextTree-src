...
import { saveUserCanvasData, loadUserCanvasData } from "@/lib/db-service"
    ...
    const loadSavedData = async () => {
      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          if (savedConnectionEvents) setConnectionEvents(savedConnectionEvents)
