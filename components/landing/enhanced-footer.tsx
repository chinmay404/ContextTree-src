        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 mb-6">
              Research-grade chat canvas for complex conversations
            </p>
            <Link
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Features", "How It Works", "Demo", "Pricing"].map(
                (item, i) => (
                  <li key={i}>
                    <Link
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Documentation", "Blog", "API Reference", "Tutorials"].map(
                (item, i) => (
                  <li key={i}>
                    <Link
                      href="#"
        ...
        <div className="pt-8 pb-8 border-t border-zinc-800/50">
          <div className="text-center mb-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              ...
              <div className="flex items-center gap-2 text-zinc-500">
                <div className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center">
                  <span className="text-xs font-bold">STF</span>
                </div>
                <span className="text-xs">Stanford</span>
              </div>
              <div className="flex items-center gap-2 text-zinc-500">
                <div className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center">
                  <span className="text-xs font-bold">HRV</span>
                </div>
                <span className="text-xs">Harvard</span>
              </div>
              <div className="flex items-center gap-2 text-zinc-500">
                <div className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center">
                  <span className="text-xs font-bold">OXF</span>
                </div>
