...
function MainNode({ id, data, selected }: NodeProps<MainNodeData>) {
  ...
  const handleCustomize = (e: React.MouseEvent) => {
    ...
    if (onCustomize) {
      ...
      // Fallback if onCustomize is not provided
      toast({
        title: "Customization",
        description: "Node customization will be available soon.",
      })
    }
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="text-xs font-medium px-1.5 py-0.5 bg-primary/10 text-primary rounded-full">
          {messages.length}
        </div>
      </div>
