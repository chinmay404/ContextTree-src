    ...
    <div className="relative group">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          />
          {/* Data pattern */}
          <div className="absolute inset-0 flex items-center justify-center opacity-5 rotate-12">
            <Layers3 size={100} style={{ color: dotColor }} />
          </div>
          <div className="absolute inset-0 flex items-center justify-center opacity-5 -rotate-12">
            <Database size={80} style={{ color: dotColor }} />
          </div>
        </div>
        ...
        <div className="relative p-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2">
                <Database size={14} style={{ color: dotColor }} />
                <span
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <FileStack size={12} style={{ color: dotColor }} />
                <span
              ...
              <div
                ...
                style={{ backgroundColor: `${dotColor}10` }}
              >
                <Archive size={12} style={{ color: dotColor }} />
                <span
                  className="text-xs font-medium"
                  style={{ color: textColor }}
                >
            ...
            <div
              ...
              style={{ backgroundColor: `${dotColor}10` }}
            >
              <Brain size={14} style={{ color: dotColor }} />
              <span
