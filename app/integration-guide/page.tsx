...
const INSTALLATION_STEPS = [
  {
    ...
    description:
      "Replace your existing node imports with the enhanced versions",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Complete guide to integrating the enhanced node components into your
            existing ReactFlow application with full customization support.
          </p>
        </div>
            ...
            <Card className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Start with the default themes and gradually customize to
                    match your brand
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Use the node showcase page to test different configurations
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Enable animations gradually - start with hover effects and
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Save your favorite themes as JSON files for easy reuse
                    across projects
                  </span>
                </li>
              </ul>
...
/>`}</code>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(
                          `// Basic entry node with custom styling
<EntryNodeEnhanced
  data={{
    label: "Welcome Message",
    messageCount: 12,
...
/>`}</code>
                ...
                <Card className="p-6 bg-yellow-50 border-yellow-200">
                  ...
                  <p className="text-slate-700 mb-3">
                    The enhanced components are designed to be backward
                    compatible with your existing node data. All original
                    properties will continue to work, and new features are
                    opt-in.
                  </p>
                  <div className="bg-yellow-100 p-3 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      <strong>Note:</strong> If a customization property is not
                      provided, the component will use sensible defaults that
        ...
        <Card className="mt-12 p-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Download the complete enhanced node package and start building
              beautiful, customizable node interfaces for your ReactFlow
              applications.
            </p>
