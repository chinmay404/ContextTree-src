...
export default function LoginPage() {
  ...
  const errorMessage = error
    ? "There was an issue with the Google sign-in. Please try again or check the debug page for more information."
    : ""

  const handleGoogleSignIn = () => {
    setIsLoading(true)
    // Use a direct URL for the callback to avoid any issues with relative URLs
    signIn("google", {
      callbackUrl: "/canvas",
    })
  }
